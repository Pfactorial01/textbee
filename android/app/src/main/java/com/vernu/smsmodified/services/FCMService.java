...
public class FCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        sendLogInput.setMessage("SMS received from firebase");
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            for (String receiver : smsPayload.getRecipients()) {
                ...
                try {
                    ...
                    SendLogDTO sendLogInput2 = new SendLogDTO();
                    sendLogInput.setMessage(e.getMessage());
                    sendLogInput.setType("error");
                    Call<SendLogDTO> logApiCall2 = ApiManager.getApiService().sendLog(deviceId, sendLogInput2);
                    logApiCall.enqueue(new Callback<SendLogDTO>() {
                        @Override
                        public void onResponse(Call<SendLogDTO> call, Response<SendLogDTO> response) {
